...
#define VAR_WAGER_MONEY                                  0x404E // Wager battles: player money stake (src/wager.c)
...
#define VAR_WAGER_PLAYER_SLOT                            0x4083 // Wager battles: staked party slot + 1, 0 = none
...
#define VAR_WAGER_OPP_MONEY                              0x408B // Wager battles: money the opponent puts up
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_WAGER_OPP_SPECIES                            0x4091 // Wager battles: species the opponent puts up, SPECIES_NONE = none
...
#define VAR_WAGER_OPP_LEVEL                              0x409B // Wager battles: level of the species above
#define VAR_ELITE_4_STATE                                0x409C
#define VAR_ARENA_TIER                                   0x409D // Underground arena: highest table beaten (src/arena.c)
#define VAR_MOSSDEEP_SPACE_CENTER_STAIR_GUARD_STATE      0x409E
#define VAR_MOSSDEEP_SPACE_CENTER_STATE                  0x409F
#define VAR_SLATEPORT_HARBOR_STATE                       0x40A0
#define VAR_ASCENSION_RANK                               0x40A1 // Player ascension rank 0..5 (src/ascension.c)
...
#define VAR_ASCENSION_REIGN_DAYS                         0x40A8 // Days held the Champion title
...
#define VAR_ASCENSION_VISITOR                            0x40B8 // Visiting champion at the League, enum AscensionVisitor
#define VAR_MT_PYRE_STATE                                0x40B9
#define VAR_NEW_MAUVILLE_STATE                           0x40BA
#define VAR_ASCENSION_CHALLENGE_DAYS                     0x40BB // Days the current challenge went unanswered
...
#define VAR_ASCENSION_BOUNTY_DAY                         0x40DB // VAR_DAYS when the last weekly bounty was paid
#define VAR_ASCENSION_NEXT_VISITOR                       0x40DC // Rotation index of the next visiting champion
...
#define VAR_ASCENSION_NO_BAG                             0x40E5 // B_VAR_NO_BAG_USE, set during ascension trials
