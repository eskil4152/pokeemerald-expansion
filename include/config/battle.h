...
#define B_FLAG_NO_WHITEOUT          FLAG_SANDBOX_NO_WHITEOUT // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
...
#define B_VAR_NO_BAG_USE         VAR_ASCENSION_NO_BAG     // If set to 1, the ability to use the Bag is disabled in Trainer battles. If set to 2, it is also disabled in wild battles.
