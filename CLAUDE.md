...
- 2026-09-18: Ascension phases 2–5 on `feature/ascension`: Ascension Shard, Shrine map, mystic/Oracle, guardian ritual, rank trials I–V with quests, reign and visiting champions, post-champion scaling, arena bounty, nurse rumours. Trainer id space is now full (864). Difficulty and economy tie-ins not done. Awaiting manual test. Cynthia added as a visitor (id 568).
- 2026-09-18: `feature/lounge` (on ascension): companions. Champions' Lounge and Residence, 11 candidates filtered by player gender, affection, outings, Promise Ring marriage, spouse follower + battle partner, ascension ceremony. Enables NPC followers and appends `CompanionSave` to SaveBlock1: breaks saves once. See `FEATURE_LOUNGE.md`. Awaiting manual test.
